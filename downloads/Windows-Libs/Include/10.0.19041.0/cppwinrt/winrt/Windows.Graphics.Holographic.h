...
namespace std
{
    ...
    template<> struct hash<winrt::Windows::Graphics::Holographic::IHolographicFrame3> : winrt::impl::hash_base<winrt::Windows::Graphics::Holographic::IHolographicFrame3> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Holographic::IHolographicFrameRenderingReport> : winrt::impl::hash_base<winrt::Windows::Graphics::Holographic::IHolographicFrameRenderingReport> {};
    template<> struct hash<winrt::Windows::Graphics::Holographic::IHolographicFrameScanoutMonitor> : winrt::impl::hash_base<winrt::Windows::Graphics::Holographic::IHolographicFrameScanoutMonitor> {};
    template<> struct hash<winrt::Windows::Graphics::Holographic::IHolographicFrameScanoutReport> : winrt::impl::hash_base<winrt::Windows::Graphics::Holographic::IHolographicFrameScanoutReport> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Holographic::IHolographicSpace3> : winrt::impl::hash_base<winrt::Windows::Graphics::Holographic::IHolographicSpace3> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Holographic::HolographicFrameRenderingReport> : winrt::impl::hash_base<winrt::Windows::Graphics::Holographic::HolographicFrameRenderingReport> {};
    template<> struct hash<winrt::Windows::Graphics::Holographic::HolographicFrameScanoutMonitor> : winrt::impl::hash_base<winrt::Windows::Graphics::Holographic::HolographicFrameScanoutMonitor> {};
    template<> struct hash<winrt::Windows::Graphics::Holographic::HolographicFrameScanoutReport> : winrt::impl::hash_base<winrt::Windows::Graphics::Holographic::HolographicFrameScanoutReport> {};
