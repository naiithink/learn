...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_ApplicationModel_IAppInfoStatics<D>::GetFromAppUserModelIdForUser(Windows::System::User const& user, param::hstring const& appUserModelId) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_ApplicationModel_IPackage8<D>::GetLogoAsRandomAccessStreamReference(Windows::Foundation::Size const& size) const
    {
        void* result{};
...
namespace winrt::Windows::ApplicationModel
{
    ...
    {
        return impl::call_factory<AppInfo, Windows::ApplicationModel::IAppInfoStatics>([&](auto&& f) { return f.Current(); });
    }
    inline auto AppInfo::GetFromAppUserModelId(param::hstring const& appUserModelId)
    {
        return impl::call_factory<AppInfo, Windows::ApplicationModel::IAppInfoStatics>([&](auto&& f) { return f.GetFromAppUserModelId(appUserModelId); });
    }
    inline auto AppInfo::GetFromAppUserModelIdForUser(Windows::System::User const& user, param::hstring const& appUserModelId)
    {
        return impl::call_factory<AppInfo, Windows::ApplicationModel::IAppInfoStatics>([&](auto&& f) { return f.GetFromAppUserModelIdForUser(user, appUserModelId); });
    }
...
namespace std
{
    ...
    template<> struct hash<winrt::Windows::ApplicationModel::IAppInfo2> : winrt::impl::hash_base<winrt::Windows::ApplicationModel::IAppInfo2> {};
    template<> struct hash<winrt::Windows::ApplicationModel::IAppInfoStatics> : winrt::impl::hash_base<winrt::Windows::ApplicationModel::IAppInfoStatics> {};
    ...
    template<> struct hash<winrt::Windows::ApplicationModel::IPackage8> : winrt::impl::hash_base<winrt::Windows::ApplicationModel::IPackage8> {};
