...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_ApplicationModel_DataTransfer_IDataPackage4<D>::ShareCanceled(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::DataTransfer::DataPackage, Windows::Foundation::IInspectable> const& handler) const
    {
        winrt::event_token token;
...
namespace std
{
    ...
    template<> struct hash<winrt::Windows::ApplicationModel::DataTransfer::IDataPackage4> : winrt::impl::hash_base<winrt::Windows::ApplicationModel::DataTransfer::IDataPackage4> {};
