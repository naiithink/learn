...
#endif
static const char *ng0 = "B = %d, E = %d, D = %d, H = %d, S = %d  :  Buzzer = %d";
static const char *ng1 = "/home/naiithink/in-Sync/Files/ISE_DS/CS131-LAB/Sources/LAB05_02_VeriTest.v";
static int ng2[] = {1, 0};
static int ng3[] = {0, 0};

void Monitor_85_2(char *);
void Monitor_85_2(char *);


static void Monitor_85_2_Func(char *t0)
{
    char *t1;
    char *t2;
    char *t3;
...
LAB2:    xsi_set_current_line(85, ng1);
    Monitor_85_2(t0);

LAB1:    return;
}

void Monitor_85_2(char *t0)
{
    char *t1;
    char *t2;
...
LAB0:    t1 = (t0 + 3304);
    t2 = (t0 + 3816);
    xsi_vlogfile_monitor((void *)Monitor_85_2_Func, t1, t2);

LAB1:    return;
}


extern void work_m_02478698030696844693_0391689811_init()
{
	static char *pe[] = {(void *)Initial_31_0,(void *)Initial_83_1,(void *)Monitor_85_2};
	xsi_register_didat("work_m_02478698030696844693_0391689811", "isim/LAB05_02_LAB05_02_sch_tb_isim_beh.exe.sim/work/m_02478698030696844693_0391689811.didat");
