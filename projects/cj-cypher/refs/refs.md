...
- [How to create an episode](https://podcasters.apple.com/support/825-how-to-create-an-episode)
...
The following is an example of a well-formed RSS feed.<br>
Apple recommends using http://podba.se/validate/ or http://castfeedvalidator.com to validate your feeds.<br>
